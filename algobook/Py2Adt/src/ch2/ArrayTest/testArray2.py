# -*- coding: utf-8 -*-
# From Data Structures and Algorithms Using Python, page 36
# File testArray2.py
...
def main():
	...
	# extract each line from the file and
	...
	# Print the results. The uppercase
	# letters have ASCII values in the
	# range 65..90 and the lowercase
	# letters are in the range 97..122.
	for i in range(26):
