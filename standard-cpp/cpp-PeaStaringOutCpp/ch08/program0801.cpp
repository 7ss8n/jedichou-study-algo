// Starting Out with CPP.pdf, page 458
// This program demostrates the searchList function,
...
int main() {
  ...
  if (results == -1) {
    ...
    // Other wise results contains the subscrit of
...
// integer array. The array list, which has a maximum of
// numElems elements, is searched for the number stored in
...
int searchList(const int list[], int numElems, int value) {
  ...
  bool found = false; // Falg to indicate if the value was found
