// Starting Out with CPP.pdf, page 106
// Description
//   This program tracks the inventroy of three widget stores
...
int main()
{
	...
	cin >> sold;
	store1 -= sold;  // Adjust store 2's inventory.
	...
	cout << "\nThe current inventory of each sotre:\n";
