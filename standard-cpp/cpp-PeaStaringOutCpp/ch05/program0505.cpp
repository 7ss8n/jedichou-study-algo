// Starting Out with CPP, page 240
// This program calcuates the number of soccer teams
// that a youth legue may create from the number of
// available players. Input validatation is demostrated
// with while loops.
