// Starting Out with CPP.pdf, page 186
// Description
...
int main()
{
	...
	// Get the numer of years at the current job.
	cout << "How many years have your worked at "
		 << "your current job? ";
	cin >> years;

	// Determin the user's loan qualifications.
