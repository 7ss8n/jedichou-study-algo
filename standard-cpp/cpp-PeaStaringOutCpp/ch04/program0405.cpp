// Starting Out with CPP.pdf, page 161
// Description:
//   This program average 3 test scores. The if statement
//   uses the = operator, but the == operator was inteneded.
