/******************************************************************************* 
 * Filename     : Program7_14.c
 * Create time  : 2007/12/29 am 11:58 
 * Description  :
 *   Program 7.14 Sorting strings 
 *
 *   Using the functions declared in the string.h header 
 *   file, you can demonstrate the effectiveness of 
 *   using pointers through an example showing a simple 
 *   method of sorting:
 ******************************************************************************/
...
/*
 * TODO : Program7_14, don't compile and debug
 */

int program7_14(void) {
    ...
    while(!sorted){
        ...
        for( i=0; i<last_string-1; i++)
            if(strcmp(pS[i], pS[i+1]>0)){    /* TODO : Program7_14.c, there is a sytanx error */
