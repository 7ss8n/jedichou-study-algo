...
int main(void)
{
	 ...
	 * the three rows. e.g. Index 2 select 6 3/4
	 */
	char size[3][12] = {
	...
	printf("\nEnter the circumference of you head above your "
		   " eyebrows in inches as a decimal value: ");
	scanf(" %f", &cranium);
	...
	else
	{
		if( your_head < headsize[0] )	/* Check for too small */
			...
			printf("\nYou are a fathead. No hat for you.\n");
	}
