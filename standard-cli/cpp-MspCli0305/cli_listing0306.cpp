// From Apress Pro Visual C++/CLI and the .NET 3.5 platform, Page 143
...
public:
	...
	// thus, can speak through the animal's virtual sequence
	// also this method overrides Cat's virtual Speak method
